...
public class Atom {
  ...
  public boolean equals(Atom that, String vThis, String vThat) {
    ...
    if ((this.left.equals(vThis) && that.left.equals(vThat))
        || (this.left.equals(vThis) && that.left.equals(vThat))) return true;
    return false;
  }
  ...
  /**
   * Returns true if this is more special than the given atom g, given that vThis is substituted by
   * vThat.
   *
  ...
  public String toString(String c, String v) {
    return this.relation
        + "("
        + (this.left.equals(c) ? v : this.left)
        + ","
        + (this.right.equals(c) ? v : this.right)
        + ")";
  }
